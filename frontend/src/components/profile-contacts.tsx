...
const icons: Record<ContactKind, ReactNode> = {
  ...
  whatsapp: (
    <svg viewBox="0 0 24 24" aria-hidden>
      <path d="M12 3.5A8.5 8.5 0 0 0 4.8 16.4L3.6 20.4l4.2-1.1A8.5 8.5 0 1 0 12 3.5Z" />
      <path
        className="icon-solid"
        d="M9.4 8.2c.14-.32.4-.3.58-.3h.42c.14 0 .3.02.4.32.16.48.62 1.52.68 1.64.04.1.06.22-.02.36-.08.14-.14.22-.28.36-.12.12-.24.26-.1.52.14.26.7 1.14 1.5 1.86.96.86 1.78 1.14 2.04 1.26.26.12.4.1.54-.08.14-.16.62-.74.8-1 .18-.26.34-.2.58-.12.24.08 1.52.72 1.78.86.26.12.44.18.5.28.08.1.06.62-.16 1.24-.22.62-1.24 1.2-1.74 1.28-.46.08-1.04.1-2.98-.62-2.34-.88-3.86-3.2-3.98-3.36-.12-.16-.94-1.26-.94-2.4 0-1.14.6-1.7.82-1.96Z"
      />
    </svg>
  ),
  rss: (
