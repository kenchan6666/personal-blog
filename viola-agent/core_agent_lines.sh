...
echo "viola line count"
echo "=================="
echo ""

echo "Core runtime"
echo "------------"
core_agent=$(count_top_level_py_lines "viola/agent")
core_bus=$(count_top_level_py_lines "viola/bus")
core_config=$(count_top_level_py_lines "viola/config")
core_cron=$(count_top_level_py_lines "viola/cron")
core_heartbeat=$(count_top_level_py_lines "viola/heartbeat")
core_session=$(count_top_level_py_lines "viola/session")
...
echo "----------------"
extra_tools=$(count_recursive_py_lines "viola/agent/tools")
extra_skills=$(count_skill_lines "viola/skills")
extra_api=$(count_recursive_py_lines "viola/api")
extra_cli=$(count_recursive_py_lines "viola/cli")
extra_channels=$(count_recursive_py_lines "viola/channels")
extra_utils=$(count_recursive_py_lines "viola/utils")
...
echo "Notes"
echo "-----"
echo "  - agent/ only counts top-level Python files under viola/agent"
echo "  - tools/ is counted separately from viola/agent/tools"
echo "  - skills/ counts .md, .py, and .sh files"
echo "  - not included here: command/, providers/, security/, templates/, viola.py, root files"
