...
from viola.utils.restart import consume_restart_notice_from_env, format_restart_completed_message
...
class ChannelManager:
    ...
    def _resolve_transcription_key(self, provider: str) -> str:
        ...
        try:
            ...
            if provider == "uniapi":
                return self.config.providers.uniapi.api_key
    ...
    def _resolve_transcription_base(self, provider: str) -> str:
        ...
        try:
            ...
            if provider == "uniapi":
                return self.config.providers.uniapi.api_base or ""
