...
Persistent storage at ``~/.viola/pairing.json`` keeps approved senders
...
from viola.config.paths import get_data_dir
from viola.utils.helpers import _write_text_atomic
