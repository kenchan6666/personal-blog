...
from viola.config.schema import Config, InlineFallbackConfig, ModelPresetConfig
from viola.providers.base import LLMProvider
from viola.providers.fallback_provider import FallbackProvider
from viola.providers.registry import find_by_name
...
def _make_provider_core(
    ...
    *,
    ...
    if backend == "anthropic":
        from viola.providers.anthropic_provider import AnthropicProvider
        ...
        from viola.providers.openai_compat_provider import OpenAICompatProvider
...
def load_provider_snapshot(
    ...
    *,
    ...
    from viola.config.loader import load_config, resolve_config_env_vars
