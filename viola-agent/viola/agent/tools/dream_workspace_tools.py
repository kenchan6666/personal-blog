"""Internal read tool used by Dream memory consolidation.

The interactive chat agent does not register these tools (`_plugin_discoverable = False`).
Durable user-facing data should be persisted via MCP / FastAPI, not workspace file tools.
"""
...
from viola.agent.tools.file_state import FileStates, _hash_file
...
from viola.utils.helpers import build_image_content_blocks, detect_image_mime
...
class ReadFileTool(_FsTool):
    ...
    def _read_office_doc(self, fp: Path) -> str:
        from viola.utils.document import extract_text
