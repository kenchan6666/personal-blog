...
from viola.agent.tools.schema import ArraySchema, StringSchema, tool_parameters_schema
from viola.bus.events import OutboundMessage
from viola.config.paths import get_workspace_path
    ...
    tool_parameters_schema(
        ...
        media=ArraySchema(
            ...
            description=(
                ...
                "Use this only when the user explicitly requests proactive/cross-channel file delivery."
            ),
        ),
        buttons=ArraySchema(
...
class MessageTool(Tool, ContextAware):
    ...
    def description(self) -> str:
        return (
            ...
            "Do NOT use local file reads to \"send\" files — use the media/attachment path or MCP delivery instead."
        )
    ...
    async def execute(
        ...
        **kwargs: Any
        ...
        from viola.utils.helpers import strip_think
