...
from viola.agent.tools.base import tool_parameters
from viola.agent.tools.schema import IntegerSchema, StringSchema, tool_parameters_schema
from viola.agent.tools.workspace_paths import _FsTool
...
class NotebookEditTool(_FsTool):
    ...
    def enabled(cls, ctx: "ToolContext") -> bool:
        return not bool(getattr(ctx.config, "persistence_via_mcp_only", False))
        ...
        **kwargs: Any,
        ...
        try:
            ...
            if not path.endswith(".ipynb"):
                return "Error: notebook_edit only works on .ipynb files. Use MCP/API tools for other files."
