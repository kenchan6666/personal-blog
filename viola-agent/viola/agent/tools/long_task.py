...
``viola.session.goal_state.goal_state_runtime_lines``) so compaction cannot hide them.
...
from viola.agent.tools.schema import StringSchema, tool_parameters_schema
from viola.bus.events import OutboundMessage
from viola.session.goal_state import (
    GOAL_STATE_KEY,
