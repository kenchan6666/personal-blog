...
This directory contains built-in skills that extend viola's capabilities.
...
When skills reference large local documentation or logs, prefer viola's built-in
